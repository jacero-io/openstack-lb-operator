...
import (
	...
	"github.com/jacero-io/openstack-lb-operator/internal/controller"
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "863d1c9c.jacero.io",
	...
	if err = (&controller.OpenStackLoadBalancerReconciler{
		Client: mgr.GetClient(),
		Scheme: mgr.GetScheme(),
		// Event recorder will be set in SetupWithManager
	}).SetupWithManager(mgr); err != nil {
		setupLog.Error(err, "unable to create controller", "controller", "OpenStackLoadBalancer")
		os.Exit(1)
	}
